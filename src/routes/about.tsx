    ...
    <div className="mx-auto max-w-2xl px-5 py-16">
      <div className="rounded-2xl border border-border bg-card p-8 shadow-sm sm:p-12">
        ...
        <div className="mt-8 space-y-6 text-lg leading-relaxed text-foreground/90">
          ...
          <p>
            Anyone can buy it. No account, no waiting, no auction deadline. Pay more than the
            current owner and the link redirects to you the moment your payment clears. You keep it
            until someone pays more than you did — and if that happens, we'll email you the price to
            take it back.
          </p>
